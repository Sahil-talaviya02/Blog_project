...
@section('content')
    ...
    <form action="{{ route('admin.update_post') }}" method="POST" id="updatePostForm">
        @csrf
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="card card-box mb-3">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea class="form-control" name="content" rows="10" cols="30" id="post_content">{!! $post->content !!}</textarea>
                ...
                <div class="card card-box mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="meta_description" id="meta_description" cols="30" rows="10" class="form-control">{{ $post->meta_description }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="card card-box mb-3">
                    <div class="card-body">
                        ...
                        <div class="d-block mb-3" style="width: 250px;">
                            <img src="/images/posts/{{ $post->featured_image }}" alt="Post Image" class="img-thumbnail"
                                id="featured_image_preview"
                                data-ijabo-default-img="/images/posts/{{ $post->featured_image }}">
                        </div>

                        <div class="form-group">
                            <label for="post_url">Post Tags:</label>
                            <input type="text" name="tags" class="form-control" placeholder="Enter post tags"
                                value="{{ $post->tags }}" data-role="tagsinput">
                        </div>
